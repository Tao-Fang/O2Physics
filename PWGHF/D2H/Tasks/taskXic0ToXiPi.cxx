...
struct HfTaskXic0ToXiPi {
  ...
  void init(InitContext&)
  {
    ...
    //std::array<bool, 9> doprocess{doprocessDataWithDCAFitter, doprocessDataWithKFParticle, doprocessMcWithKFParticle, doprocessDataWithKFParticleMl, doprocessMcWithKFParticleMl, doprocessDataWithKFParticleFT0C, doprocessDataWithKFParticleMlFT0C, doprocessDataWithKFParticleFT0M, doprocessDataWithKFParticleMlFT0M};
    ...
    if (doprocessMcWithKFParticle || doprocessMcWithKFParticleMl) {
      ...
      std::vector<AxisSpec> axesAcc = {thnAxisGenPtD, thnAxisGenPtB, thnAxisOrigin, thnAxisNumPvContr};
    ...
    if (fillCent) {
      ...
      std::vector<AxisSpec> axesWithBdtCent = {thnAxisPromptScore, thnAxisMass, thnAxisPt, thnAxisCent, thnAxisPtPion, thnConfigAxisNumPvContr};
      std::vector<AxisSpec> axesWithCent = {thnAxisMass, thnAxisPt, thnAxisCent, thnAxisPtPion, thnConfigAxisNumPvContr};
